...
public class CuboidManager {
            ...
            if (isInteractive) {
                ...
                while (!exit) {
                    ...
                    try {
                        ...
                        System.out.println("No input detected. Exiting interactive mode.");
                        exit = true;
                    } catch (Exception e) {
                ...
                System.out.println("Running in non-interactive mode. Skipping menu options.");
            }
    ...
    private static void recomputeAllCuboids(List<String> latticeDimensions, String cuboidDir) {
        try {
            ...
            int createdCount = 0;
            for (List<String> combination : allCombinations) {
                String cuboidName = combination.isEmpty() ? "base_cuboid" : 
                         String.join("_", combination).replaceAll("\\s+", "_");
    ...
    private static void createAndSaveCuboid(Cuboid cuboid, List<String> dimensions, 
        ...
        for (JoinedRecord record : cuboid.joinedRecords) {
            ...
            groupedRecords.computeIfAbsent(key.toString(), k -> new ArrayList<>())
                          .add(record);
        }
    ...
    private static void performCuboidOperations(List<List<String>> cuboids, String cuboidDir) {
        ...
        while (!exit) {
            ...
            try {
                ...
                System.out.println("No input detected. Returning to main menu.");
                exit = true;
            } catch (Exception e) {
                System.out.println("Invalid input. Please try again.");
                scanner.nextLine(); // Clear the invalid input
    ...
    private static void filterCuboidData(List<String> dimensions, String cuboidDir) {
        ...
        try {
            ...
            do {
                ...
                try {
                    int columnIndex = scanner.nextInt() - 1; // Adjust for 0-based indexing
                    scanner.nextLine();
                    ...
                    System.out.println("No input detected. Exiting filter operation.");
                    return;
                } catch (Exception e) {
                    System.out.println("Invalid input. Please try again.");
                    scanner.nextLine(); // Clear the invalid input
